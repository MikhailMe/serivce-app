    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        plus1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (i1 < 20) {
                    i1++;
                    Administrator.products.put(ProductType.HOT_DOG, i1);
        ...
        plus2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (i2 < 20) {
                    i2++;
                    Administrator.products.put(ProductType.HAMBURGER, i2);
        ...
        plus3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (i3 < 20) {
                    i3++;
                    Administrator.products.put(ProductType.HOT_CORN, i3);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.container, new LiquidFragment());
                ft.commit();
            }
        });
